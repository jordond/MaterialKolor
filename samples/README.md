...
Every sample is the same small app, **Tasks**, built three times on three different UI stacks. The behaviour, the copy and the data are shared. Only the UI and the theme wiring change.

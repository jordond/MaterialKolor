...
import com.materialkolor.utils.ColorUtils.argbFromLab
import com.materialkolor.utils.ColorUtils.labFromArgb
...
internal class PointProviderLab : PointProvider {
     ...
     */
    override fun toInt(point: DoubleArray): Int = argbFromLab(point[0], point[1], point[2])

...
# Mirror of material-kolor-material3/consumer-rules.pro (Android consumer rules).
-keep public class com.materialkolor.material3.*Kt { public *; }
-keep public class com.materialkolor.material3.ktx.*Kt { public *; }

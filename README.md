...
[![Compose Multiplatform](https://img.shields.io/badge/Compose%20Multiplatform-1.6.0--rc01-blue)](https://github.com/JetBrains/compose-multiplatform)
...
kotlin {
    sourceSets {
        commonMain {
            dependencies {
                implementation("com.materialkolor:material-kolor:1.4.0-rc01")
            }
        }
    }
}

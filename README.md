...
[![Compose Multiplatform](https://img.shields.io/badge/Compose%20Multiplatform-v1.4.3-blue)](https://github.com/JetBrains/compose-multiplatform)
...
kotlin {
    sourceSets {
        commonMain {
            dependencies {
                implementation("com.materialkolor:material-kolor:1.2.3")
            }
        }
    }
}

...
class ColorSchemeTest {
    ...
    @Test
    fun animateColorScheme_preservesAllPrimaryColors() =
        runComposeUiTest {
    ...
    @Test
    fun animateColorScheme_preservesSecondaryColors() =
        runComposeUiTest {
            var result: ColorScheme? = null
    ...
    @Test
    fun animateColorScheme_preservesTertiaryColors() =
        runComposeUiTest {
            var result: ColorScheme? = null
    ...
    @Test
    fun animateColorScheme_preservesSurfaceColors() =
        runComposeUiTest {
            var result: ColorScheme? = null
    ...
    @Test
    fun animateColorScheme_preservesErrorAndBackgroundColors() =
        runComposeUiTest {
            var result: ColorScheme? = null
    ...
    @Test
    fun animateColorScheme_preservesUtilityColors() =
        runComposeUiTest {
            var result: ColorScheme? = null
    ...
    @Test
    fun animateColorScheme_preservesFixedColors() =
        runComposeUiTest {
            var result: ColorScheme? = null
    ...
    @Test
    fun animateColorScheme_handlesColorSchemeTransition() =
        runComposeUiTest {
    ...
    @Test
    fun animateColorScheme_worksWithDarkColorScheme() =
        runComposeUiTest {
            var result: ColorScheme? = null
